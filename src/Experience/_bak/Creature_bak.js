...
//         this.textures.shadeMaskTex = this.resources.items.foxShadeTex
//     }
//
//     setBaseMaterial() {
...
//             shader.uniforms.shadowStepMin = { value: this.experience.world.lights.backLight.userData.shadowStepMin }
...
//         // this.animation.actions.bowCheck = this.animation.mixer.clipAction(this.resource.animations[1])
//
